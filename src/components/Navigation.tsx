  ...
  return (
    <nav class="">
      <div class="flex justify-end  items-center">
        <div class="menu">
          <ul class="flex text-slate-300 font-sans font-semibold gap-6 text-xl">
            <li>
              <a href="/" class="">
                Home
              </a>
...
export const LeftNav = () => {
  return (
    <nav class="fixed w-24 h-screen onlyrefNoise left-0 top-0 opacity-100 z-50 flex items-center justify-end flex-col pointer-events-none bg-background">
      <div class="logo absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90">
        <div class="text-4xl">
          <span class="text-foreground">Only</span>
          <span class="text-accent">Ref</span>
        </div>
      </div>
